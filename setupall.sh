...
"
# script
wget -O /etc/pam.d/common-password "https://raw.githubusercontent.com/macisvpn/inject-69/master/common-password"
...
wget -O /etc/squid/squid.conf "https://raw.githubusercontent.com/macisvpn/inject-69/master/squid.conf"
sed -i "s/ipserver/$myip/g" /etc/squid3/squid.conf
sed -i "s/ipserver/$myip/g" /etc/squid/squid.conf
# openvpn
apt-get -y install openvpn
wget -O /etc/openvpn/openvpn.tar "https://raw.githubusercontent.com/macisvpn/inject-69/master/openvpn.tar"
cd /etc/openvpn/;tar xf openvpn.tar;rm openvpn.tar
wget -O /etc/rc.local "https://raw.githubusercontent.com/macisvpn/inject-69/master/rc.local";chmod +x /etc/rc.local
...
wget -O /etc/nginx/conf.d/vps.conf "https://raw.githubusercontent.com/macisvpn/inject-69/master/vps.conf"
sed -i 's/listen = \/var\/run\/php7.0-fpm.sock/listen = 127.0.0.1:9000/g' /etc/php/7.0/fpm/pool.d/www.conf
# etc
wget -O /home/vps/public_html/client.ovpn "https://raw.githubusercontent.com/macisvpn/inject-69/master/client.ovpn"
